...
export enum CredentialState { UNINITIALIZED = 0, ACTIVE = 1, REVOKED = 2 }
...
export type ImpureCircuits<PS> = {
  issueCredential(context: __compactRuntime.CircuitContext<PS>,
                  id_0: Uint8Array,
                  metadata_0: string): __compactRuntime.CircuitResults<PS, []>;
  verifyCredential(context: __compactRuntime.CircuitContext<PS>,
                   providedId_0: Uint8Array): __compactRuntime.CircuitResults<PS, []>;
...
export type Circuits<PS> = {
  ...
  verifyCredential(context: __compactRuntime.CircuitContext<PS>,
                   providedId_0: Uint8Array): __compactRuntime.CircuitResults<PS, []>;
  revokeCredential(context: __compactRuntime.CircuitContext<PS>): __compactRuntime.CircuitResults<PS, []>;
  authorityPublicKey(context: __compactRuntime.CircuitContext<PS>,
                     sk_0: Uint8Array,
